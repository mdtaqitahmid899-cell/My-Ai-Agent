...
// Fix: Import IconProps from types.ts to use the shared type definition for icon components.
import type { Feature, IconProps, Language } from './types';

// Fix: The local IconProps type definition has been moved to types.ts to be shared.
